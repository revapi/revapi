...
A variant of <<a_overriding_method_removed, Overriding Method Removed>>, but the method in the super class is abstract.
...
As with <<a_final_method_added_to_non_final_class, Final Method Added To Non-final Class>>, this can break if a subclass
