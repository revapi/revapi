...
public class YamlElement extends JacksonElement<YamlElement> {
    public YamlElement(API api, Archive archive, String filePath, TreeNode node, String key) {
        super(api, archive, filePath, node, key);
    }

    public YamlElement(API api, Archive archive, String filePath, TreeNode node, int index) {
