 ...
 * <p>
 * Note that, generally speaking, the references should not be used in {@link TreeFilter} implementations because the
 * filters are used during the construction of the {@link ElementForest} meaning that the references are not yet
